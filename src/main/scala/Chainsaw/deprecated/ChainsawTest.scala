...
import Chainsaw._
import Chainsaw.deprecated.ChainsawTest._
...
case class ChainsawTest(
  ...
  def doTest(): ChainsawTestReport = {
    ...
    val config = SimConfig
      ...
      //      .addIncludeDir("/home/ltr/Chainsaw/src/main/resources/flopocoGenerated/")
      //      .addRtl("/home/ltr/Chainsaw/src/main/resources/flopocoGenerated/IntMultiAdder_signedIn_0_n_20_wIn_100_target_VirtexUltrascalePlus.vhd")
      //      .withIVerilog
      .workspaceName(testName).withFstWave
    config._backend = gen.simBackEnd
