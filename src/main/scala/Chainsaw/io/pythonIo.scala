...
object pythonIo {
  ...
  /** export BigDecimal signals to a .npz file caution: this function convert BigDecimal to Double, might cost too much
    * time when signal is long
    */
  ...
  /** export named BigDecimal signals to a .npz file caution: this function convert BigDecimal to Double, might cost too
    * much time when signal is long
    */
  ...
  /** export named BigDecimal 2d signals to a .npz file caution: this function convert BigDecimal to Double, might cost
    * too much time when signal is long
    */
  ...
  /** convert named BigDecimal 2d signals to series of signals converted signal name: {name}_2d_i.npz
    */
  ...
  /** convert named Double 2d signals to series of signals converted signal name: name_2d_i
    */
  ...
  /** export one BigDecimal signal caution: this function convert BigDecimal to Double, might cost too much time when
    * signal is long
    */
  ...
  /** import BigDecimal signals form npz file caution: this function convert BigDecimal to Double, might cost too much
    * time when signal is long
    */
  def importSignals(file: File): Seq[Signal] = {
    ...
    assert(
      freeMemory * 0.9 > neededMemory,
      s"Warning: not enough memory to import signal, needed: $neededMemory, available: $freeMemory"
    )
  ...
  /** import named Double signals form npz file caution: this function convert BigDecimal to Double, might cost too much
    * time when signal is long
    */
  ...
  /** import 2d BigDecimal signals form npz file caution: this function convert BigDecimal to Double, might cost too
    * much time when signal is long
    */
  ...
  /** import one BigDecimal signal caution: this function convert Double to BigDecimal, might cost too much time when
    * signal is long
    */
  def importSignal(file: File): Signal = importSignals(file).head

  /** import one Double signal caution: this function convert Double to BigDecimal, might cost too much time when signal
    * is long
    */
