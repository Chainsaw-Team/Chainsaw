...
case class Ieee2Flopoco(exponentSize: Int, mantissaSize: Int, override val family: XilinxDeviceFamily, override val targetFrequency: HertzNumber) extends BlackBox with floatingFlopoco {
  override val operatorName = "InputIEEE"
  override val entityName = "InputIEEE"
  override val params = Seq(("wEIn", exponentSize), ("wFIn", mantissaSize), ("wEOut", exponentSize), ("wFOut", mantissaSize))
