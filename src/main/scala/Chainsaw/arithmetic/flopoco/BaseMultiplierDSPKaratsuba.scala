 ...
 *
 * @param width  width of base multiplier
 * @param height height of base multiplier
 * @param split number of splits
 */
case class BaseMultiplierDSPKaratsuba(width: Int, height: Int, split: Int) extends FlopocoOperator {
