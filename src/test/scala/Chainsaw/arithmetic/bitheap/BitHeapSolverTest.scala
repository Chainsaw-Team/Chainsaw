...
class BitHeapSolverTest extends ChainsawFlatSpec {
  ...
  val testCases: Seq[Seq[ArithInfo]] = Seq(
    ...
    Seq(ArithInfo(64, 128), ArithInfo(64, 192), ArithInfo(64, 160), ArithInfo(64, 160, isPositive = false), ArithInfo(64, 160, isPositive = false),
      ArithInfo(32, 192), ArithInfo(32, 192), ArithInfo(1, 224)) // case from Bm
  )
